...
func TestFolder2Txtar(t *testing.T) {
	...
	want := []string{
		...
		"../kube/testdata/golden/import_reader_writer.txt",
		"../kube/testdata/golden/import_save_from_reader.txt",
		"../kube/testdata/golden/import_with_CRDs_and_remove_app_name_and_group_by_kind.txt",
		"../kube/testdata/golden/import_with_CRDs_and_remove_app_name_and_split_by_name.txt",
		"../kube/testdata/golden/import_with_CRDs_and_remove_app_name_containing_dash_and_group_by_kind.txt",
