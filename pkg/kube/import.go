...
var headerComment = "Code generated by go-terriyaki. EDIT AS MUCH AS YOU LIKE."
...
type jamel struct {
	...
	objectsMeta       map[string]meta.Metadata  // obj name => obj meta
...
func newImporter(
	...
	j := &jamel{
		...
		objectsMeta:       make(map[string]meta.Metadata),
...
func (j *jamel) generate(splitYaml []string) error {
	...
	for _, y := range splitYaml {
		data := []byte(y)
		m, err := meta.ExtractMetadata(data)
		if err != nil {
		...
		pkgPath, err := meta.PkgPathFromAPIVersion(m.APIVersion)
		if err != nil {
...
func (j *jamel) yaml2GoJen(data []byte, m *meta.Metadata) (
	*jen.Statement,
	error,
) {
