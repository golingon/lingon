...
import (
	...
	"github.com/golingon/lingon/docs/kubernetes/score"
)
...
func ExampleScore() {
	...
	// communicate with this pod. Note, this feature needs to be supported by
	// the CNI implementation used in the Kubernetes cluster to
	//             have an effect.
}
