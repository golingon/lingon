											...
											Items: &apiextensionsv1.JSONSchemaPropsOrArray{Schema: &apiextensionsv1.JSONSchemaProps{
												...
												Properties: map[string]apiextensionsv1.JSONSchemaProps{
													"matchType": {
														...
														Enum:        []apiextensionsv1.JSON{{Raw: []byte("\"!=\"")}, {Raw: []byte("\"=\"")}, {Raw: []byte("\"=~\"")}, {Raw: []byte("\"!~\"")}},
														Type:        "string",
													},
													"name": {
														...
														Items: &apiextensionsv1.JSONSchemaPropsOrArray{Schema: &apiextensionsv1.JSONSchemaProps{
															...
															Properties: map[string]apiextensionsv1.JSONSchemaProps{
																...
																"type": {
																	...
																	Enum:        []apiextensionsv1.JSON{{Raw: []byte("\"team\"")}, {Raw: []byte("\"teams\"")}, {Raw: []byte("\"user\"")}, {Raw: []byte("\"escalation\"")}, {Raw: []byte("\"schedule\"")}},
																	MinLength:   P(int64(1)),
																	Type:        "string",
																},
																"username": {
											...
											Items: &apiextensionsv1.JSONSchemaPropsOrArray{Schema: &apiextensionsv1.JSONSchemaProps{
												...
												Properties: map[string]apiextensionsv1.JSONSchemaProps{
													...
													"parseMode": {
														...
														Enum:        []apiextensionsv1.JSON{{Raw: []byte("\"MarkdownV2\"")}, {Raw: []byte("\"Markdown\"")}, {Raw: []byte("\"HTML\"")}},
														Type:        "string",
													},
													"sendResolved": {
