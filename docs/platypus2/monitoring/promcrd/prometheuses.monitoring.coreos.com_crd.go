...
var PrometheusesMonitoringCoreosComCRD = &apiextensionsv1.CustomResourceDefinition{
					...
					"spec": {
						...
						Properties: map[string]apiextensionsv1.JSONSchemaProps{
									...
									"nodeAffinity": {
										...
										Properties: map[string]apiextensionsv1.JSONSchemaProps{
											...
											"requiredDuringSchedulingIgnoredDuringExecution": {
												...
												Properties: map[string]apiextensionsv1.JSONSchemaProps{"nodeSelectorTerms": {
							...
							"alerting": {
								...
								Properties: map[string]apiextensionsv1.JSONSchemaProps{"alertmanagers": {
												...
												"postStart": {
													...
													Properties: map[string]apiextensionsv1.JSONSchemaProps{
														"exec": {
															...
															Properties: map[string]apiextensionsv1.JSONSchemaProps{"command": {
...
`,
										...
										"ports": {
											...
											Type:         "array",
											XListMapKeys: []string{"containerPort", "protocol"},
											XListType:    P("map"),
										},
										"readinessProbe": {
...
`,
										...
										"volumeDevices": {
											...
											Items: &apiextensionsv1.JSONSchemaPropsOrArray{Schema: &apiextensionsv1.JSONSchemaProps{
												...
												Required: []string{"devicePath", "name"},
												Type:     "object",
											}},
											Type: "array",
										},
...
`,
							...
							"evaluationInterval": {
								Default:     &apiextensionsv1.JSON{Raw: []byte("\"30s\"")},
							...
							"excludedFromEnforcement": {
								...
								Items: &apiextensionsv1.JSONSchemaPropsOrArray{Schema: &apiextensionsv1.JSONSchemaProps{
									...
									Properties: map[string]apiextensionsv1.JSONSchemaProps{
										"group": {
											Default:     &apiextensionsv1.JSON{Raw: []byte("\"monitoring.coreos.com\"")},
											Description: "Group of the referent. When not specified, it defaults to `monitoring.coreos.com`",
											Enum:        []apiextensionsv1.JSON{{Raw: []byte("\"monitoring.coreos.com\"")}},
											Type:        "string",
										},
										"name": {
										...
										"resource": {
											...
											Enum:        []apiextensionsv1.JSON{{Raw: []byte("\"prometheusrules\"")}, {Raw: []byte("\"servicemonitors\"")}, {Raw: []byte("\"podmonitors\"")}, {Raw: []byte("\"probes\"")}},
											Type:        "string",
										},
									},
							...
							"exemplars": {
								...
								Properties: map[string]apiextensionsv1.JSONSchemaProps{"maxSize": {
							...
							"imagePullPolicy": {
								...
								Enum:        []apiextensionsv1.JSON{{Raw: []byte("\"\"")}, {Raw: []byte("\"Always\"")}, {Raw: []byte("\"Never\"")}, {Raw: []byte("\"IfNotPresent\"")}},
								Type:        "string",
							},
							"imagePullSecrets": {
...
`,
							...
							"logFormat": {
								...
								Enum:        []apiextensionsv1.JSON{{Raw: []byte("\"\"")}, {Raw: []byte("\"logfmt\"")}, {Raw: []byte("\"json\"")}},
								Type:        "string",
							},
							"logLevel": {
								Description: "Log level for Prometheus to be configured with.",
								Enum:        []apiextensionsv1.JSON{{Raw: []byte("\"\"")}, {Raw: []byte("\"debug\"")}, {Raw: []byte("\"info\"")}, {Raw: []byte("\"warn\"")}, {Raw: []byte("\"error\"")}},
								Type:        "string",
							},
							"minReadySeconds": {
...
`,
							...
							"portName": {
								Default:     &apiextensionsv1.JSON{Raw: []byte("\"web\"")},
...
`,
							...
							"prometheusRulesExcludedFromEnforce": {
								...
								Items: &apiextensionsv1.JSONSchemaPropsOrArray{Schema: &apiextensionsv1.JSONSchemaProps{
									...
									Required: []string{"ruleName", "ruleNamespace"},
									Type:     "object",
								}},
								Type: "array",
							},
...
`,
							...
							"rules": {
								...
								Properties: map[string]apiextensionsv1.JSONSchemaProps{"alert": {
							...
							"storage": {
								...
								Properties: map[string]apiextensionsv1.JSONSchemaProps{
									...
									"ephemeral": {
										...
										Properties: map[string]apiextensionsv1.JSONSchemaProps{"volumeClaimTemplate": {
											Description: `
...
`,
								Properties: map[string]apiextensionsv1.JSONSchemaProps{
									...
									"blockSize": {
										Default:     &apiextensionsv1.JSON{Raw: []byte("\"2h\"")},
...
`,
							...
							"tsdb": {
								...
								Properties: map[string]apiextensionsv1.JSONSchemaProps{"outOfOrderTimeWindow": {
...
`,
										...
										"iscsi": {
											...
											Required: []string{"iqn", "lun", "targetPortal"},
											Type:     "object",
										},
										"name": {
													...
													Items: &apiextensionsv1.JSONSchemaPropsOrArray{Schema: &apiextensionsv1.JSONSchemaProps{
														...
														Properties: map[string]apiextensionsv1.JSONSchemaProps{
															...
															"downwardAPI": {
																...
																Properties: map[string]apiextensionsv1.JSONSchemaProps{"items": {
										...
										"rbd": {
											...
											Required: []string{"image", "monitors"},
											Type:     "object",
										},
										"scaleIO": {
											...
											Required: []string{"gateway", "secretRef", "system"},
											Type:     "object",
										},
										"secret": {
							...
							"web": {
								...
								Properties: map[string]apiextensionsv1.JSONSchemaProps{
											...
											"headers": {
												...
												Properties: map[string]apiextensionsv1.JSONSchemaProps{
													...
													"xContentTypeOptions": {
														...
														Enum:        []apiextensionsv1.JSON{{Raw: []byte("\"\"")}, {Raw: []byte("\"NoSniff\"")}},
														Type:        "string",
													},
													"xFrameOptions": {
														...
														Enum:        []apiextensionsv1.JSON{{Raw: []byte("\"\"")}, {Raw: []byte("\"Deny\"")}, {Raw: []byte("\"SameOrigin\"")}},
														Type:        "string",
													},
													"xXSSProtection": {
									...
									"tlsConfig": {
										...
										Required: []string{"cert", "keySecret"},
										Type:     "object",
									},
								},
								Type: "object",
						...
						Properties: map[string]apiextensionsv1.JSONSchemaProps{
							...
							"conditions": {
								...
								Items: &apiextensionsv1.JSONSchemaPropsOrArray{Schema: &apiextensionsv1.JSONSchemaProps{
									...
									Required: []string{"lastTransitionTime", "status", "type"},
									Type:     "object",
								}},
								Type:         "array",
							...
							"shardStatuses": {
								...
								Items: &apiextensionsv1.JSONSchemaPropsOrArray{Schema: &apiextensionsv1.JSONSchemaProps{
									...
									Required: []string{"availableReplicas", "replicas", "shardID", "unavailableReplicas", "updatedReplicas"},
									Type:     "object",
								}},
								Type:         "array",
