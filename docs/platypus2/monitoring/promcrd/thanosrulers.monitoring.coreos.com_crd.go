...
var ThanosrulersMonitoringCoreosComCRD = &apiextensionsv1.CustomResourceDefinition{
...
`,
							...
							"evaluationInterval": {
								Default:     &apiextensionsv1.JSON{Raw: []byte("\"15s\"")},
...
`,
							...
							"retention": {
								Default:     &apiextensionsv1.JSON{Raw: []byte("\"24h\"")},
