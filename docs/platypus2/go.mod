...
require (
	...
	github.com/golingon/lingon v0.0.0-20240930124930-f197c1949f1f
...
require (
	...
	github.com/VictoriaMetrics/VictoriaMetrics v1.104.0 // indirect
	...
	knative.dev/pkg v0.0.0-20240930065954-503173341499 // indirect
