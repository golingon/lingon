...
var (
	...
	ErrNoStateShow        = errors.New("no state to show")
)
...
func (r *Client) Run(
	...
	if err := r.initStack(ctx, stack); err != nil {
		return fmt.Errorf(
...
func (r *Client) initStack(ctx context.Context, stack Stacker) error {
	if stack.StackName() == "" {
