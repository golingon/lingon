...
var AlertmanagerRulesPrometheusRule = &v1.PrometheusRule{
...
var ConfigReloadersPrometheusRule = &v1.PrometheusRule{
	ObjectMeta: metav1.ObjectMeta{
		Labels: map[string]string{
			"app":                          "kube-prometheus-stack",
			"app.kubernetes.io/instance":   "kube-prometheus-stack",
...
var EtcdPrometheusRule = &v1.PrometheusRule{
	ObjectMeta: metav1.ObjectMeta{
		Labels: map[string]string{
			"app":                          "kube-prometheus-stack",
			"app.kubernetes.io/instance":   "kube-prometheus-stack",
...
var GeneralRulesPrometheusRule = &v1.PrometheusRule{
	ObjectMeta: metav1.ObjectMeta{
		Labels: map[string]string{
			"app":                          "kube-prometheus-stack",
			"app.kubernetes.io/instance":   "kube-prometheus-stack",
				...
				Rules: []v1.Rule{
					{
						...
						Expr: intstr.IntOrString{
							StrVal: "100 * (count(up == 0) BY (job, namespace, service) / count(up) BY (job, namespace, service)) > 10",
							Type:   intstr.Type(int64(1)),
						},
						For:    "10m",
						Labels: map[string]string{"severity": "warning"},
...
var K8SRulesPrometheusRule = &v1.PrometheusRule{
	ObjectMeta: metav1.ObjectMeta{
		Labels: map[string]string{
			"app":                          "kube-prometheus-stack",
			"app.kubernetes.io/instance":   "kube-prometheus-stack",
...
var KubeApiserverAvailabilityRulesPrometheusRule = &v1.PrometheusRule{
	ObjectMeta: metav1.ObjectMeta{
		Labels: map[string]string{
			"app":                          "kube-prometheus-stack",
			"app.kubernetes.io/instance":   "kube-prometheus-stack",
...
var KubeApiserverBurnrateRulesPrometheusRule = &v1.PrometheusRule{
	ObjectMeta: metav1.ObjectMeta{
		Labels: map[string]string{
			"app":                          "kube-prometheus-stack",
			"app.kubernetes.io/instance":   "kube-prometheus-stack",
...
var KubeApiserverHistogramRulesPrometheusRule = &v1.PrometheusRule{
	ObjectMeta: metav1.ObjectMeta{
		Labels: map[string]string{
			"app":                          "kube-prometheus-stack",
			"app.kubernetes.io/instance":   "kube-prometheus-stack",
...
var KubeApiserverSlosPrometheusRule = &v1.PrometheusRule{
	ObjectMeta: metav1.ObjectMeta{
		Labels: map[string]string{
			"app":                          "kube-prometheus-stack",
			"app.kubernetes.io/instance":   "kube-prometheus-stack",
...
var KubePrometheusGeneralRulesPrometheusRule = &v1.PrometheusRule{
	ObjectMeta: metav1.ObjectMeta{
		Labels: map[string]string{
			"app":                          "kube-prometheus-stack",
			"app.kubernetes.io/instance":   "kube-prometheus-stack",
...
var KubePrometheusNodeRecordingRulesPrometheusRule = &v1.PrometheusRule{
	ObjectMeta: metav1.ObjectMeta{
		Labels: map[string]string{
			"app":                          "kube-prometheus-stack",
			"app.kubernetes.io/instance":   "kube-prometheus-stack",
...
var KubeSchedulerRulesPrometheusRule = &v1.PrometheusRule{
	ObjectMeta: metav1.ObjectMeta{
		Labels: map[string]string{
			"app":                          "kube-prometheus-stack",
			"app.kubernetes.io/instance":   "kube-prometheus-stack",
...
var KubeStateMetricsPrometheusRule = &v1.PrometheusRule{
	ObjectMeta: metav1.ObjectMeta{
		Labels: map[string]string{
			"app":                          "kube-prometheus-stack",
			"app.kubernetes.io/instance":   "kube-prometheus-stack",
				...
				Rules: []v1.Rule{
					{
						...
						Expr: intstr.IntOrString{
							StrVal: "stdvar (kube_state_metrics_total_shards{job=\"kube-state-metrics\"}) != 0",
							Type:   intstr.Type(int64(1)),
						},
						For:    "15m",
						Labels: map[string]string{"severity": "critical"},
...
var KubeletRulesPrometheusRule = &v1.PrometheusRule{
	ObjectMeta: metav1.ObjectMeta{
		Labels: map[string]string{
			"app":                          "kube-prometheus-stack",
			"app.kubernetes.io/instance":   "kube-prometheus-stack",
...
var KubernetesAppsPrometheusRule = &v1.PrometheusRule{
	ObjectMeta: metav1.ObjectMeta{
		Labels: map[string]string{
			"app":                          "kube-prometheus-stack",
			"app.kubernetes.io/instance":   "kube-prometheus-stack",
...
var KubernetesResourcesPrometheusRule = &v1.PrometheusRule{
	ObjectMeta: metav1.ObjectMeta{
		Labels: map[string]string{
			"app":                          "kube-prometheus-stack",
			"app.kubernetes.io/instance":   "kube-prometheus-stack",
...
var KubernetesStoragePrometheusRule = &v1.PrometheusRule{
	ObjectMeta: metav1.ObjectMeta{
		Labels: map[string]string{
			"app":                          "kube-prometheus-stack",
			"app.kubernetes.io/instance":   "kube-prometheus-stack",
...
var KubernetesSystemApiserverPrometheusRule = &v1.PrometheusRule{
	ObjectMeta: metav1.ObjectMeta{
		Labels: map[string]string{
			"app":                          "kube-prometheus-stack",
			"app.kubernetes.io/instance":   "kube-prometheus-stack",
...
var KubernetesSystemControllerManagerPrometheusRule = &v1.PrometheusRule{
	ObjectMeta: metav1.ObjectMeta{
		Labels: map[string]string{
			"app":                          "kube-prometheus-stack",
			"app.kubernetes.io/instance":   "kube-prometheus-stack",
...
var KubernetesSystemKubeProxyPrometheusRule = &v1.PrometheusRule{
	ObjectMeta: metav1.ObjectMeta{
		Labels: map[string]string{
			"app":                          "kube-prometheus-stack",
			"app.kubernetes.io/instance":   "kube-prometheus-stack",
...
var KubernetesSystemKubeletPrometheusRule = &v1.PrometheusRule{
	ObjectMeta: metav1.ObjectMeta{
		Labels: map[string]string{
			"app":                          "kube-prometheus-stack",
			"app.kubernetes.io/instance":   "kube-prometheus-stack",
...
var KubernetesSystemPrometheusRule = &v1.PrometheusRule{
	ObjectMeta: metav1.ObjectMeta{
		Labels: map[string]string{
			"app":                          "kube-prometheus-stack",
			"app.kubernetes.io/instance":   "kube-prometheus-stack",
...
var KubernetesSystemSchedulerPrometheusRule = &v1.PrometheusRule{
	ObjectMeta: metav1.ObjectMeta{
		Labels: map[string]string{
			"app":                          "kube-prometheus-stack",
			"app.kubernetes.io/instance":   "kube-prometheus-stack",
...
var NodeExporterPrometheusRule = &v1.PrometheusRule{
	ObjectMeta: metav1.ObjectMeta{
		Labels: map[string]string{
			"app":                          "kube-prometheus-stack",
			"app.kubernetes.io/instance":   "kube-prometheus-stack",
...
var NodeExporterRulesPrometheusRule = &v1.PrometheusRule{
	ObjectMeta: metav1.ObjectMeta{
		Labels: map[string]string{
			"app":                          "kube-prometheus-stack",
			"app.kubernetes.io/instance":   "kube-prometheus-stack",
...
var NodeNetworkPrometheusRule = &v1.PrometheusRule{
	ObjectMeta: metav1.ObjectMeta{
		Labels: map[string]string{
			"app":                          "kube-prometheus-stack",
			"app.kubernetes.io/instance":   "kube-prometheus-stack",
...
var NodeRulesPrometheusRule = &v1.PrometheusRule{
	ObjectMeta: metav1.ObjectMeta{
		Labels: map[string]string{
			"app":                          "kube-prometheus-stack",
			"app.kubernetes.io/instance":   "kube-prometheus-stack",
...
var PrometheusOperatorPrometheusRule = &v1.PrometheusRule{
	ObjectMeta: metav1.ObjectMeta{
		Labels: map[string]string{
			"app":                          "kube-prometheus-stack",
			"app.kubernetes.io/instance":   "kube-prometheus-stack",
				...
				Rules: []v1.Rule{
					{
						...
						Expr: intstr.IntOrString{
							StrVal: "min_over_time(prometheus_operator_syncs{status=\"failed\",job=\"kube-prometheus-stack-operator\",namespace=\"monitoring\"}[5m]) > 0",
							Type:   intstr.Type(int64(1)),
						},
						For:    "10m",
						Labels: map[string]string{"severity": "warning"},
						...
						Expr: intstr.IntOrString{
							StrVal: "(sum by (controller,namespace,cluster) (rate(prometheus_operator_reconcile_errors_total{job=\"kube-prometheus-stack-operator\",namespace=\"monitoring\"}[5m]))) / (sum by (controller,namespace,cluster) (rate(prometheus_operator_reconcile_operations_total{job=\"kube-prometheus-stack-operator\",namespace=\"monitoring\"}[5m]))) > 0.1",
							Type:   intstr.Type(int64(1)),
						},
						For:    "10m",
						Labels: map[string]string{"severity": "warning"},
						...
						Expr: intstr.IntOrString{
							StrVal: "rate(prometheus_operator_node_address_lookup_errors_total{job=\"kube-prometheus-stack-operator\",namespace=\"monitoring\"}[5m]) > 0.1",
							Type:   intstr.Type(int64(1)),
						},
						For:    "10m",
						Labels: map[string]string{"severity": "warning"},
						...
						Expr: intstr.IntOrString{
							StrVal: "min by (controller,namespace,cluster) (max_over_time(prometheus_operator_ready{job=\"kube-prometheus-stack-operator\",namespace=\"monitoring\"}[5m]) == 0)",
							Type:   intstr.Type(int64(1)),
						},
						For:    "5m",
						Labels: map[string]string{"severity": "warning"},
						...
						Expr: intstr.IntOrString{
							StrVal: "min_over_time(prometheus_operator_managed_resources{state=\"rejected\",job=\"kube-prometheus-stack-operator\",namespace=\"monitoring\"}[5m]) > 0",
							Type:   intstr.Type(int64(1)),
						},
						For:    "5m",
						Labels: map[string]string{"severity": "warning"},
...
var PrometheusPrometheusRule = &v1.PrometheusRule{
	ObjectMeta: metav1.ObjectMeta{
		Labels: map[string]string{
			"app":                          "kube-prometheus-stack",
			"app.kubernetes.io/instance":   "kube-prometheus-stack",
				...
				Rules: []v1.Rule{
					{
						...
						Expr: intstr.IntOrString{
							StrVal: "increase(prometheus_tsdb_reloads_failures_total{job=\"kube-prometheus-stack-prometheus\",namespace=\"monitoring\"}[3h]) > 0",
							Type:   intstr.Type(int64(1)),
						},
						For:    "4h",
						Labels: map[string]string{"severity": "warning"},
						...
						Expr: intstr.IntOrString{
							StrVal: "increase(prometheus_tsdb_compactions_failed_total{job=\"kube-prometheus-stack-prometheus\",namespace=\"monitoring\"}[3h]) > 0",
							Type:   intstr.Type(int64(1)),
						},
						For:    "4h",
						Labels: map[string]string{"severity": "warning"},
						...
						Expr: intstr.IntOrString{
							StrVal: "rate(prometheus_target_scrapes_sample_duplicate_timestamp_total{job=\"kube-prometheus-stack-prometheus\",namespace=\"monitoring\"}[5m]) > 0",
							Type:   intstr.Type(int64(1)),
						},
						For:    "10m",
						Labels: map[string]string{"severity": "warning"},
						...
						Expr: intstr.IntOrString{
							StrVal: "rate(prometheus_target_scrapes_sample_out_of_order_total{job=\"kube-prometheus-stack-prometheus\",namespace=\"monitoring\"}[5m]) > 0",
							Type:   intstr.Type(int64(1)),
						},
						For:    "10m",
						Labels: map[string]string{"severity": "warning"},
						...
						Expr: intstr.IntOrString{
							StrVal: "increase(prometheus_rule_evaluation_failures_total{job=\"kube-prometheus-stack-prometheus\",namespace=\"monitoring\"}[5m]) > 0",
							Type:   intstr.Type(int64(1)),
						},
						For:    "15m",
						Labels: map[string]string{"severity": "critical"},
						...
						Expr: intstr.IntOrString{
							StrVal: "increase(prometheus_rule_group_iterations_missed_total{job=\"kube-prometheus-stack-prometheus\",namespace=\"monitoring\"}[5m]) > 0",
							Type:   intstr.Type(int64(1)),
						},
						For:    "15m",
						Labels: map[string]string{"severity": "warning"},
						...
						Expr: intstr.IntOrString{
							StrVal: "increase(prometheus_target_scrape_pool_exceeded_target_limit_total{job=\"kube-prometheus-stack-prometheus\",namespace=\"monitoring\"}[5m]) > 0",
							Type:   intstr.Type(int64(1)),
						},
						For:    "15m",
						Labels: map[string]string{"severity": "warning"},
						...
						Expr: intstr.IntOrString{
							StrVal: "increase(prometheus_target_scrape_pool_exceeded_label_limits_total{job=\"kube-prometheus-stack-prometheus\",namespace=\"monitoring\"}[5m]) > 0",
							Type:   intstr.Type(int64(1)),
						},
						For:    "15m",
						Labels: map[string]string{"severity": "warning"},
						...
						Expr: intstr.IntOrString{
							StrVal: "increase(prometheus_target_scrapes_exceeded_body_size_limit_total{job=\"kube-prometheus-stack-prometheus\",namespace=\"monitoring\"}[5m]) > 0",
							Type:   intstr.Type(int64(1)),
						},
						For:    "15m",
						Labels: map[string]string{"severity": "warning"},
						...
						Expr: intstr.IntOrString{
							StrVal: "increase(prometheus_target_scrapes_exceeded_sample_limit_total{job=\"kube-prometheus-stack-prometheus\",namespace=\"monitoring\"}[5m]) > 0",
							Type:   intstr.Type(int64(1)),
						},
						For:    "15m",
						Labels: map[string]string{"severity": "warning"},
						...
						Expr: intstr.IntOrString{
							StrVal: "increase(prometheus_target_sync_failed_total{job=\"kube-prometheus-stack-prometheus\",namespace=\"monitoring\"}[30m]) > 0",
							Type:   intstr.Type(int64(1)),
						},
						For:    "5m",
						Labels: map[string]string{"severity": "critical"},
						...
						Expr: intstr.IntOrString{
							StrVal: "avg_over_time(prometheus_engine_queries{job=\"kube-prometheus-stack-prometheus\",namespace=\"monitoring\"}[5m]) / max_over_time(prometheus_engine_queries_concurrent_max{job=\"kube-prometheus-stack-prometheus\",namespace=\"monitoring\"}[5m]) > 0.8",
							Type:   intstr.Type(int64(1)),
						},
						For:    "15m",
						Labels: map[string]string{"severity": "warning"},
